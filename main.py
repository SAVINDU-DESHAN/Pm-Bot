...
@Client.on_message(filters.incoming & filters.chat(-1001793793431))
async def bchanl(bot, update, broadcast_ids={}): 
    ...
    out = await bot.send_message(-1001445943650,f"Ads Broadcast Started! You will be notified with log file when all the users are notified.")
    ...
    if failed == 0:
        await bot.send_message(-1001445943650, f"broadcast completed in `{completed_in}`\n\nTotal users {total_users}.\nTotal done {done}, {success} success and {failed} failed.")
    else:
        await bot.send_document(-1001445943650, 'broadcastlog.txt', caption=f"broadcast completed in `{completed_in}`\n\nTotal users {total_users}.\nTotal done {done}, {success} success and {failed} failed.")
...
async def startprivate(bot, message):
    ...
    countb = await db.total_users_count()
    count = await bot.get_chat_members_count(-1001445943650)
    counta = await bot.get_chat_members_count(-1001445943650)
        ...
        await inline_query.answer(
            results=[
                InlineQueryResultVideo(
                    ...
                    thumb_url="https://te.legra.ph/file/5a46aef0bbc8e4f2047a8.jpg",
                    caption=f"""
...
𝙱𝚘𝚝 = @MeMe_Hub_Chat_bot
Post By {inline_query.from_user.mention}
""",
                    reply_markup=InlineKeyboardMarkup([[              
                 InlineKeyboardButton('🍁 Owner 🍁', user_id="@SAVINDU_DSHAN")
                 ],
                 [
                 InlineKeyboardButton('🐞 Report Bugs 🐞', user_id="SAVINDU_DESHAN")
                 ],
                 [
                 InlineKeyboardButton('ᴍᴇᴍᴇʜᴜʙ ᴏᴍғғɪᴄɪᴀʟ ʙᴏᴍᴛ 『🇱🇰』', user_id="@MeMe_Hub_Chat_bot")
                 ],
                 [
        ...
        await inline_query.answer(
            results=[
                InlineQueryResultPhoto(
                    title="Share Karapam",
                    photo_url="https://te.legra.ph/file/3f520167119956dca6c5e.jpg",
                    caption=f"""
...
""",
                    reply_markup=InlineKeyboardMarkup([[              
                 InlineKeyboardButton('MemeHub Telegram 🇱🇰', url="t.me/meme_hub_lk")
                 ],
                 [
                 InlineKeyboardButton('Owner 👑', user_id="@SAVINDU_DESHAN")
                 ],
                 [
                 InlineKeyboardButton('Official Bot🤖', user_id="@MeMe_Hub_Chat_bot")
                 ],
                 [
                 InlineKeyboardButton("⚜️Special Entrance⚜️", url="https://t.me/+04PUDakd_HM2MmM1")
                 ]])
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠻⢿⣿⣿⣿⣿⠟⠁
😁
හැමෝම කියම්නෙ අම්නිත් අය කම්රපු හැටි🥲
කවුරුත් කියම්නෙ නෑ අපි කරම්පු  හැටි🤬
අපි තමයි හොම්දටම කම්රේ🤏😎
🤘කපුටාස් has hit the plane

R E D D Aᴹᵞ❥͜͡⃝ᶫᵒᵛᵉ⃝➤⃟̱̱❤️ـــ٨ـہہـ♡ـ٨ـہــ♥️⃝➸⃟̀̀❁͜͡🌈᭄Meme Hub O F F I C I A L*➸⃟̀̀
 
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
➖➖➖➖➖➖➖➖➖➖
@MeMe_Hub_Chat_bot has been deployed!
➖➖➖➖➖➖➖➖➖➖
Support: @Rawana_Developers_Chat
➖➖➖➖➖➖➖➖➖➖
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
""")
...
print("[Rawana] Deployed Successfully !")        
Client.run()
